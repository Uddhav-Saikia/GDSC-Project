...
window.addEventListener('scroll', function() {
  ...
  if (scrollPosition > -50*VH && scrollPosition < 80*VH) { 
    ...
    if (localStorage.getItem('theme') === 'dark') {
      var col_1 = window.getComputedStyle(document.documentElement).getPropertyValue('--sidebar-color-dark');
	...
	if (localStorage.getItem('theme') === 'dark') {
		var col_1 = window.getComputedStyle(document.documentElement).getPropertyValue('--sidebar-hover-dark');
		element.style.backgroundColor = col_1; 
	  }
  }
});
